                                        ...
                                        <div className="p-6 bg-amber-50/50 border border-amber-100 rounded-sm space-y-4">
                                            <div className="flex items-start gap-4">
                                                ...
                                                <label htmlFor="checkout-natural-acknowledgement" className="text-[11px] font-medium text-neutral-600 leading-relaxed cursor-pointer selection:bg-brand-pink/10">
                                                    I acknowledge that this masterpiece is crafted from <span className="font-bold text-neutral-900">natural materials</span>. I understand that organic variations in grain, texture, and color are inherent to the material and are not considered defects.
                                                </label>
                                            </div>
                                        </div>
                                    )}
