                            ...
                            <tbody className="divide-y divide-neutral-50">
                                {mockTCSData.map((row, i) => (
                                    <motion.tr key={i} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.06 }}
                                        ...
                                        <td className="px-6 py-5 text-sm font-bold text-red-500 font-inter">−₹{row.tcsDeducted.toLocaleString()}</td>
                                        <td className="px-6 py-5 text-sm font-black text-neutral-950 font-inter">₹{row.netAmount.toLocaleString()}</td>
                                        <td className="px-6 py-5">
