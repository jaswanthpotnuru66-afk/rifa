            ...
            <section id="home-why" className="py-16 md:py-20 bg-white border-b border-neutral-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-8">
                    ...
                    >
                        <Link 
                            to="/why-rifa" 
                            className="text-[10px] font-black uppercase tracking-[0.3em] text-neutral-400 hover:text-neutral-950 transition-all border-b border-transparent hover:border-neutral-950 pb-1"
                        >
                            Explore Our Full Story <ArrowRight size={12} className="inline-block ml-2" />
                        </Link>
                    </motion.div>
                </div>
            </section>
