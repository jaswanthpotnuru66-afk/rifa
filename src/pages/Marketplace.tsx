            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                ...
                <header className="mb-16 md:mb-24 text-center max-w-4xl mx-auto">
                    <motion.div
                        ...
                        className="space-y-6"
                    >
                        <span className="text-[10px] font-black uppercase tracking-[0.4em] text-brand-pink">Curated Collection</span>
                        <h1 className="text-6xl md:text-8xl font-serif font-bold text-neutral-950 tracking-tighter leading-none">
                            The <br />
                            <span className="italic font-light text-neutral-400 text-5xl md:text-7xl">Marketplace.</span>
                        </h1>
                        <p className="text-lg font-light text-neutral-500 max-w-xl mx-auto leading-relaxed mt-8">
                            A showcase of handcrafted legacies, where traditional artistry meets contemporary vision. Each piece is ready for its next chapter.
                        </p>
                    </motion.div>
                </header>
