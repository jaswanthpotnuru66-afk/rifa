        ...
        <div className="min-h-screen bg-[#FAF7F2] selection:bg-brand-pink/20 pb-20 pt-20 md:pt-28">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-8 py-6">
                <div className="flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.2em] text-neutral-400">
                    ...
                    <Link to={`/artisan/${product.artisanId}`} className="hover:text-brand-pink transition-colors">Artisan</Link>
                    <ChevronRight size={10} />
                        ...
                        <div className="space-y-8 pt-8 border-t border-neutral-100">
                            ...
                            <div className="space-y-4 pt-8">
                                <button 
                                    ...
                                    className="w-full py-6 bg-neutral-950 text-white text-[10px] font-black uppercase tracking-[0.4em] hover:bg-neutral-800 transition-all shadow-2xl flex items-center justify-center gap-4 group"
                                >
