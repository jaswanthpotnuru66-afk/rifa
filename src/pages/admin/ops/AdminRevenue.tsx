...
const AdminRevenue = () => {
    ...
    const StatCard = ({ label, value, subValue, trend }: { label: string; value: string; subValue: string; trend?: string }) => (
        <div className="bg-white border border-neutral-100 p-8 rounded-sm shadow-sm group hover:border-brand-pink/30 transition-all">
            ...
            <h3 className="text-3xl font-serif font-bold text-neutral-950 tracking-tight mb-2">{value}</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                            ...
                            {revenueByMaker.map((maker, idx) => (
                                <div key={maker.id} className="flex items-center gap-6 p-4 hover:bg-neutral-50 transition-all rounded-sm group">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-[10px] text-neutral-400 font-medium uppercase tracking-widest mt-0.5">{maker.totalOrders} Orders · ₹{maker.totalRevenue.toLocaleString()} GMV</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-sm font-black text-brand-pink">₹{(maker.totalRevenue * 0.05).toLocaleString()}</p>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white border border-neutral-100 p-8 rounded-sm space-y-4">
                            ...
                            <h4 className="text-2xl font-serif font-bold text-neutral-950 tracking-tight">₹148.50</h4>
