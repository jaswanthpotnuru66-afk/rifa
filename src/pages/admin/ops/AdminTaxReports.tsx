                            ...
                            <tbody className="divide-y divide-neutral-50 text-[11px] font-medium text-neutral-600">
                                {mockTCSMonthly.map(row => (
                                    <tr key={row.month} className="hover:bg-neutral-50/50 transition-colors">
                                        <td className="px-6 py-5 font-bold text-neutral-900">{row.month} 2025</td>
                                        <td className="px-6 py-5 text-right">₹{row.totalGrossSales.toLocaleString()}</td>
                                        <td className="px-6 py-5 text-right font-black text-brand-pink">₹{row.totalTCSCollected.toLocaleString()}</td>
                                        <td className="px-6 py-5 text-center">{row.makerCount}</td>
                                        <td className="px-6 py-5 text-right">₹{row.averagePerMaker.toLocaleString()}</td>
