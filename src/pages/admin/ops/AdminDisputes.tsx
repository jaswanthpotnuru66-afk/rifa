            ...
            <div className="space-y-8 animate-in fade-in duration-500 pb-24">
                ...
                <div className="space-y-3">
                    ...
                    {filteredDisputes.length > 0 ? filteredDisputes.map(dispute => {
                        ...
                        return (
                            <div key={dispute.id} className={`bg-white border rounded-sm transition-all shadow-sm ${
                                isUrgent ? 'bg-red-50/50 border-red-100' :
                                ...
                                <div className="flex flex-col lg:grid lg:grid-cols-[100px_100px_1.2fr_1.2fr_1fr_100px_80px_100px_100px_80px] gap-4 p-4 lg:p-6 items-center">
                                    ...
                                    <div className="text-xs font-black text-neutral-950">{dispute.id}</div>
                                    <Link to={`/admin/ops/orders/${dispute.orderId}`} className="text-xs font-bold text-brand-pink hover:underline">{dispute.orderId}</Link>
                                    ...
                                    <div className="text-[10px] font-medium text-neutral-500">{new Date(dispute.dateRaised).toLocaleDateString()}</div>

                                    <div className="text-center">
                                        <span className={`text-xs font-black ${isUrgent ? 'text-red-600' : 'text-neutral-950'}`}>{daysOpen}d</span>
                                    </div>
