                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    {kpis.map((kpi, i) => (
                        ...
                        >
                            ...
                            <p className={`text-2xl font-serif font-bold mt-1 tracking-tight ${kpi.color}`}>{kpi.value}</p>
                                ...
                                <div className="flex flex-col md:flex-row md:items-center gap-4 px-6 py-5">
                                    ...
                                    <div className="flex justify-between md:block min-w-[80px]">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-bold text-neutral-900 text-right md:text-left">₹{payout.grossAmount.toLocaleString()}</p>
                                        </div>
                                    </div>
                                    <div className="flex justify-between md:block min-w-[80px]">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-bold text-red-500 text-right md:text-left">−₹{payout.commission}</p>
                                        </div>
                                    </div>
                                    <div className="flex justify-between md:block min-w-[60px]">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-bold text-red-500 text-right md:text-left">−₹{payout.tcs}</p>
                                        </div>
                                    </div>
                                    <div className="flex justify-between md:block min-w-[80px]">
                                        ...
                                        <div>
                                            ...
                                            <p className={`text-xs font-bold text-right md:text-left ${payout.shippingAdj < 0 ? 'text-red-500' : 'text-neutral-300'}`}>
                                    ...
                                    <div className="flex justify-between items-center md:block min-w-[90px] pt-4 md:pt-0 border-t border-neutral-50 md:border-0 mt-2 md:mt-0">
                                        ...
                                        <div className="text-right md:text-left">
                                            ...
                                            <p className="text-lg md:text-base font-serif font-black text-neutral-950">₹{payout.netPaid.toLocaleString()}</p>
                                        </div>
                                    </div>
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        {payout.orders.map(o => (
                                                            <div key={o.id} className="flex flex-col md:grid md:grid-cols-5 py-3 border-b border-neutral-100 last:border-0 text-xs gap-1 md:gap-0">
                                                                ...
                                                                <div className="flex justify-between md:block"><span className="md:hidden text-[10px] text-neutral-400">Amount</span><span className="font-bold text-neutral-950">₹{o.amount.toLocaleString()}</span></div>
                                                                <div className="flex justify-between md:block"><span className="md:hidden text-[10px] text-neutral-400">Commission</span><span className="font-bold text-red-500">−₹{o.commission}</span></div>
                                                                <div className="flex justify-between md:block"><span className="md:hidden text-[10px] text-neutral-400">TCS</span><span className="font-bold text-red-400">−₹{o.tcs}</span></div>
                                                                <div className="flex justify-between md:block pt-2 border-t border-neutral-200/50 md:pt-0 md:border-0 mt-1 md:mt-0"><span className="md:hidden text-[10px] font-black text-neutral-900">Net</span><span className="font-black text-brand-pink md:text-neutral-950 text-right">₹{(o.amount - o.commission - o.tcs).toLocaleString()}</span></div>
                                                            </div>
                                                        ))}
                                                    </div>
                                                ) : (
