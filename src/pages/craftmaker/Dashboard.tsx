            ...
            <div className="bg-white border border-brand-pink/20 shadow-sm rounded-sm p-6 lg:p-8 mb-8 relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6">
                    ...
                    <div className="text-right shrink-0">
                        <p className="text-3xl font-serif font-black text-brand-pink">50%</p>
                ...
                {stats.map((stat, i) => (
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-3xl font-serif font-bold text-neutral-950 mt-1 tracking-tight">{stat.value}</p>
            ...
            <div className="grid lg:grid-cols-12 gap-8 mb-10">
                            ...
                            <tbody className="divide-y divide-neutral-50">
                                {mockOrders.slice(0, 6).map(order => (
                                    <tr key={order.id} className="group hover:bg-neutral-50/80 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-xs font-black text-neutral-950">₹{order.amount.toLocaleString()}</td>
                                        <td className="px-6 py-4">
                ...
                <div className="lg:col-span-4 space-y-5">
                    ...
                    <div className="bg-[#0a0a0a] rounded-sm p-6 text-white relative overflow-hidden">
                        ...
                        <p className="text-4xl font-serif font-bold text-white tracking-tight">₹18,340</p>
                        <p className="text-[10px] text-green-400 font-black uppercase tracking-widest mt-2">↑ 12% vs last month</p>
