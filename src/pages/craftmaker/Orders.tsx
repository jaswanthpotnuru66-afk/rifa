                ...
                <div className="flex items-center gap-6 border-b border-neutral-100 overflow-x-auto no-scrollbar pb-px">
                    {STATUS_TABS.map(tab => (
                        ...
                        >
                            ...
                            <span className={`text-[9px] px-1.5 py-0.5 rounded-full font-black ${activeTab === tab ? 'bg-brand-pink text-white' : 'bg-neutral-100 text-neutral-400'}`}>
                                {counts[tab] || 0}
                            </span>
                            {activeTab === tab && (
                                ...
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    <div className="flex-1 flex flex-col md:grid md:grid-cols-[40px_120px_160px_1fr_100px_100px_120px_40px] gap-4 md:items-center p-4 md:p-5">
                                        ...
                                        <div className="hidden md:block">
                                            <p className="text-sm font-black text-neutral-900 group-hover:text-brand-pink transition-colors">{order.id}</p>
                                            {order.isCustom && (
                                        ...
                                        <div className="flex justify-between md:block">
                                            ...
                                            <div className="md:text-right">
                                                <p className="text-sm font-black text-neutral-950">₹{order.amount.toLocaleString()}</p>
                                            </div>
                                        </div>
