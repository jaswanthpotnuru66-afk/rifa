                                ...
                                >
                                    ...
                                    <div className="flex flex-wrap md:flex-nowrap items-center justify-between md:justify-end gap-6 md:gap-0 mt-4 md:mt-0 pt-4 md:pt-0 border-t md:border-0 border-neutral-50">
                                        <div className="w-24 md:text-right">
                                            ...
                                            <span className="text-sm font-bold text-neutral-950">₹{listing.basePrice.toLocaleString()}</span>
                                        </div>
                                        <div className="w-32 md:text-center">
                                            ...
                                            <span className={`text-xs font-medium ${listing.stock < 5 && !listing.isUnlimited ? 'text-red-500' : 'text-neutral-500'}`}>
                                        ...
                                        <div className="w-20 md:text-center">
                                            ...
                                            <div className="flex items-center md:justify-center gap-1.5 text-neutral-400">
                                                <Eye size={12} />
                                        ...
                                        <div className="w-20 md:text-center">
                                            ...
                                            <div className="flex items-center md:justify-center gap-1.5 text-neutral-950">
