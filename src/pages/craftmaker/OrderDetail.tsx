                    ...
                    <div className="flex-1 space-y-8">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div>
                                ...
                                <p className="text-neutral-500 text-sm font-medium uppercase tracking-widest mt-1">Placed on {order.date}</p>
                            </div>
                        ...
                        <Card title="Order Items">
                            <div className="flex items-center gap-6 p-4 hover:bg-neutral-50 transition-all rounded-sm group">
                                ...
                                <div className="text-right">
                                    ...
                                    <div className="text-xl font-bold text-neutral-950">₹{order.amount.toLocaleString()}</div>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card title="Secure Messaging">
                            <div className="space-y-6">
                                ...
                                <div className="flex items-end gap-4 pt-6 border-t border-neutral-100">
                                    ...
                                    <button className="w-14 h-14 bg-neutral-950 text-white rounded-sm flex items-center justify-center hover:bg-brand-pink transition-all">
                                        <Send size={20} />
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="w-full lg:w-[380px] shrink-0 space-y-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4 pt-6 border-t border-neutral-50">
                                    ...
                                    <div className="pt-6 border-t border-neutral-100 flex justify-between items-baseline">
                                        ...
                                        <span className="text-2xl font-serif font-bold text-brand-pink">₹{(order.amount * 0.94).toFixed(0)}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white border border-neutral-100 rounded-sm p-8 shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="p-3 bg-neutral-50 rounded-sm flex items-center justify-between text-[10px] font-black uppercase tracking-widest">
                ...
                <div className="space-y-6">
                    <div className="relative aspect-video bg-neutral-50 rounded-sm overflow-hidden flex items-center justify-center border border-neutral-100">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/40 backdrop-blur-sm">
                            ...
                            <span className="text-2xl font-serif font-bold text-amber-600 mt-1">38:12:45</span>
